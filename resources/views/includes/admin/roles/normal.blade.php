...
<li>
  <a href="{{ route('products-ali-express-import') }}" class=" wave-effect"><i class="icofont-cart"></i>{{ __('Import Ali Express Product') }}</a>
</li>
...
<li>
  ...
  <a href="{{ route('admin-prod-import',$storename) }}"><i class="fas fa-upload"></i>{{ __('Bulk Product Upload') }}</a>
...
<li>
  ...
  <a href="{{ route('admin-coupon-index',$storename) }}" class=" wave-effect"><i class="fas fa-percentage"></i>{{ __('Set Coupons') }}</a>
...
<li>
  ...
  <li>
    ...
    <a href="{{ route('admin-staff-index',$storename) }}" class=" wave-effect"><i class="fas fa-user-secret"></i>{{ __('Manage Staffs') }}</a>
  ...
  <li>
    ...
    <a href="{{ route('admin-subs-index',$storename) }}" class=" wave-effect"><i class="fas fa-users-cog mr-2"></i>{{ __('Subscribers') }}</a>
