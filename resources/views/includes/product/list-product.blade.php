															...
															<div class="right-area">
																	<div class="stars">
					                                                  <div class="ratings">
																		...
																		<h4 class="price">{{ $prod->showPrice($storename) }} <del>{{ $prod->showPreviousPrice($storename) }}</del> </h4>
																		<p class="text"><a href="{{ route('front.product',[$storename,$prod->slug]) }}">{{ mb_strlen($prod->name,'utf-8') > 35 ? mb_substr($prod->name,0,35,'utf-8').'...' : $prod->name }}</a></p>
															</div>
														</div>
													</li>
