      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          @if(isset($bcat))
              ...
              <li>
                <a href="{{ route('front.blogcategory',[$storename,$bcat->slug]) }}">
                  {{ $bcat->name }}
                </a>
              </li>
          ...
          @elseif(isset($slug))
              ...
              <li>
                <a href="{{ route('front.blogtags',[$storename,$slug]) }}">
                  {{ $langg->lang35 }}: {{ $slug }}
                </a>
              </li>
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-4">
              <div class="blog-box">
                ...
                <div class="details">
                    <a href="{{route('front.blogshow',[$storename,$blogg->id])}}">
                      <h4 class="blog-title">
                  ...
                  <a class="read-more-btn" href="{{route('front.blogshow',[$storename,$blogg->id])}}">{{ $langg->lang38 }}</a>
                </div>
            </div>
        </div>
