...
@section('content')
	...
	<section class="slider-buttom-category d-none d-md-block">
		<div class="container-fluid">
			<div class="row">
				@foreach($categories->where('storename',$storename)->where('is_featured','=',1) as $cat)
					<div class="col-xl-2 col-lg-3 col-md-4 sc-common-padding">
						<a href="{{ route('front.category',[$storename,$cat->slug]) }}" class="single-category">
							<div class="left">
								<h5 class="title">
									{{ $cat->name }}
								</h5>
	...
	<script>
        $(window).on('load',function() {
            ...
            setTimeout(function(){
                ...
                $('#extraData').load('{{route('front.extraIndex',$storename)}}');
