    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <ul class="pages">
          ...
          <li><a href="{{route('front.category',[$storename,$productt->category->slug])}}">{{$productt->category->name}}</a></li>

          @if(!empty($productt->subcategory))

          <li><a

              href="{{ route('front.subcat',[$storename,'slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug]) }}">{{$productt->subcategory->name}}</a>
          ...
          <li><a
              ...
              href="{{ route('front.childcat',[$storename,'slug1' => $productt->category->slug, 'slug2' => $productt->subcategory->slug, 'slug3' => $productt->childcategory->slug]) }}">{{$productt->childcategory->name}}</a>

          </li>

          @endif

          <li><a href="{{ route('front.product', [$storename,$productt->slug]) }}">{{ $productt->name }}</a>
...
<section class="product-details-page">
  ...
  <div class="container">
          ...
          <div class="xzoom-container">
            ...
            <div class="product-price">
              ...
              <p class="title">{{ $langg->lang87 }} :</p>
                    ...
                    <p class="price"><span id="sizeprice">{{ $productt->showPrice($storename) }}</span>

                      <small><del>{{ $productt->showPreviousPrice($storename) }}</del></small></p>
                  ...
                  <input type="hidden" id="product_price" value="{{ round($productt->vendorPrice($storename) * $curr->value,2) }}">
                  ...
                  <div class="info-meta-3">
                    ...
                    <ul class="meta-list">
                      ...
                      <li class="addtocart">
                        ...
                        <a href="{{ route('affiliate.product', [$storename,$productt->slug]) }}" target="_blank"><i
                      ...
                      <li class="favorite">
                        ...
                        <a href="javascript:;" class="add-to-wish"
                          ...
                          data-href="{{ route('user-wishlist-add',[$storename,$productt->id]) }}"><i class="icofont-heart-alt"></i></a>
                      ...
                      <li class="compare">
                        ...
                        <a href="javascript:;" class="add-to-compare"
                          ...
                          data-href="{{ route('product.compare.add',[$storename,$productt->id]) }}"><i class="icofont-exchange"></i></a>
                      ...
                      <div id="tabs-3" class="tab-content-area">
                        ...
                        <div id="replay-area">
                          ...
                          <div class="write-comment-area">
                            ...
                            <form id="reviewform" action="{{route('front.review.submit',$storename)}}"

                              data-href="{{ route('front.reviews',[$storename,$productt->id]) }}" method="POST">
    ...
    <div class="col-lg-3">
      ...
      <div class="seller-info mt-3">
        ...
        <div class="content">
          ...
          @else
          <?php $admin = App\Models\Admin::where('storename',$storename)->first(); ?>
              {{ ($admin->shop_name) ? $admin->shop_name : 'ShopyPall' }}
    ...
    @if( $productt->user_id  != 0)
        ...
        <a href="{{ route('front.vendor',[$storename,str_replace(' ', '-', $productt->user->id)] ) }}" class="view-stor">{{ $langg->lang249 }}</a>
                    ...
                    <ul class="list">
                      ...
                      <li>
                        ...
                        <a class="favorite-prod view-stor"
                          ...
                          data-href="{{ route('user-favorite',[$storename,'data1' => Auth::guard('web')->user()->id, 'data2' => $productt->user->id]) }}"
 ...
 <div class="gocover" style="background: url({{ asset('assets/images/'.$gs->loader) }}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
                    ...
                    <div class="login-area">
                        ...
                        <div class="login-form">
                            ...
                            <form id="reportform" action="{{ route('product.report',$storename) }}" method="POST">
...
<script type="text/javascript">
  ...
  $(document).on("submit", "#emailreply1", function () {
    ...
    $.ajax({
      ...
      url: "{{URL::to($storename.'/user/admin/user/send/message')}}",
...
<script type="text/javascript">
  ...
  $(document).on("submit", "#emailreply", function () {
    ...
    $.ajax({
      ...
      url: "{{URL::to($storename.'/vendor/contact')}}",
