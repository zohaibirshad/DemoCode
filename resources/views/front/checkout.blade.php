		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="pages">
					...
					<li>
						<a href="{{ route('front.checkout',$storename) }}">
							{{ $langg->lang136 }}
						</a>
					</li>
				</ul>
										...
										<div class="order-area">
											...
											<div class="order-item">
												...
												<div class="product-content">
													<p class="name"><a
														href="{{ route('front.product', [$storename,$product['item']['slug']]) }}"
														target="_blank">{{ $product['item']['name'] }}</a></p>
														<div class="unit-price">
															<h5 class="label">{{ $langg->lang754 }} : </h5>
															<p>{{ App\Models\Product::convertPrice($storename,$product['item']['price']) }}</p>
														</div>
														...
														<div class="total-price">
															...
															<p>{{ App\Models\Product::convertPrice($storename,$product['price']) }}
															</p>
														</div>
													</div>
												</div>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="nav flex-column"  role="tablist" aria-orientation="vertical">
															...
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('paypal.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'paypal','slug2' => 0]) }}" id="v-pills-tab1-tab" data-toggle="pill" href="#v-pills-tab1" role="tab" aria-controls="v-pills-tab1" aria-selected="true">
																<div class="icon">
															...
															<a class="nav-link payment" data-val="" data-show="yes" data-form="{{route('stripe.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'stripe','slug2' => 0]) }}" id="v-pills-tab2-tab" data-toggle="pill" href="#v-pills-tab2" role="tab" aria-controls="v-pills-tab2" aria-selected="false">
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
															...
															@if($gs->cod_check == 1)
															@if($digital == 0)
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('cash.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'cod','slug2' => 0]) }}" id="v-pills-tab3-tab" data-toggle="pill" href="#v-pills-tab3" role="tab" aria-controls="v-pills-tab3" aria-selected="false">
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
															...
															@endif
															@if($gs->is_razorpay == 1)
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('razorpay.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'razorpay','slug2' => 0]) }}"  id="v-pills-tab6-tab" data-toggle="pill" href="#v-pills-tab6" role="tab" aria-controls="v-pills-tab6" aria-selected="false">
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
															...
															<a class="nav-link payment" data-val="paystack" data-show="no" data-form="{{route('paystack.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'paystack','slug2' => 0]) }}" id="v-pills-tab7-tab" data-toggle="pill" href="#v-pills-tab7" role="tab" aria-controls="v-pills-tab7" aria-selected="false">
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
															...
															@if($gs->is_molly == 1)
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('molly.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'molly','slug2' => 0]) }}" id="v-pills-tab8-tab" data-toggle="pill" href="#v-pills-tab8" role="tab" aria-controls="v-pills-tab8" aria-selected="false">
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
															...
															<a class="nav-link amazon-radio" data-val="" data-show="no" id="v-pills-tab9-tab" data-toggle="pill" href="#v-pills-tab9" role="tab" aria-controls="v-pills-tab9" aria-selected="false" id="v-pills-tab9-tab " >
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
															...
															<a class="nav-link payment" data-val="" data-show="yes" data-form="{{route('gateway.submit',$storename)}}" data-href="{{ route('front.load.payment',[$storename,'slug1' => 'other','slug2' => $gt->id]) }}" id="v-pills-tab{{ $gt->id }}-tab" data-toggle="pill" href="#v-pills-tab{{ $gt->id }}" role="tab" aria-controls="v-pills-tab{{ $gt->id }}" aria-selected="false">
																<div class="icon">
																	<span class="radio"></span>
																</div>
																<p>
						...
						<div class="order-box">
							...
							<ul class="order-list">
								<li>
									...
									<P>
										<b
										class="cart-total">{{ Session::has('cart') ? App\Models\Product::convertPrice($storename,Session::get('cart')->totalPrice) : '0.00' }}</b>
									</P>
								</li>
							...
							<div class="total-price">
								...
								<p>
									...
									@else
									<span id="total-cost">{{ App\Models\Product::convertPrice($storename,$totalPrice) }}</span>
									@endif
							...
							<div class="final-price">
								...
								@else
								<span id="final-cost">{{ App\Models\Product::convertPrice($storename,$totalPrice) }}</span>
								@endif
							...
							{{-- 						<a href="{{ route('front.checkout',$storename) }}" class="order-btn mt-4">
								{{ $langg->lang135 }}
							</a> --}}
						</div>
					</div>
						...
						<div class="tab-pane fade show active" id="nav-log" role="tabpanel" aria-labelledby="nav-log-tab">
							<div class="login-area">
								...
								<div class="login-form signin-form">
									...
									<form id="loginform" action="{{ route('user.login.submit',$storename) }}" method="POST">
										{{ csrf_field() }}
										...
										<div class="form-forgot-pass">
											...
											<div class="right">
												<a href="{{ route('user-forgot',$storename) }}">
													{{ $langg->lang176 }}
												</a>
											</div>
										</div>
						...
						<div class="tab-pane fade" id="nav-reg" role="tabpanel" aria-labelledby="nav-reg-tab">
							<div class="login-area signup-area">
								...
								<div class="login-form signup-form">
									@include('includes.admin.form-login')
									<form id="registerform" action="{{route('user-register-submit',$storename)}}" method="POST">
										{{ csrf_field() }}
...
<script type="text/javascript">
	var amazonClientId = 'amzn1.application-oa2-client.a0acbc9ba07d44de8db9135729b6a0e1';
	var amazonSellerId = '7ffa614263f6b8f72e8538440ea9a11ae4fb1b37f5e1bb4fd2983ec06493f877';
...
<script type="text/javascript">
	...
	authorization: function() {
      ...
      authRequest = amazon.Login.authorize(loginOptions, "/preview/amazon/checkout");
    },
