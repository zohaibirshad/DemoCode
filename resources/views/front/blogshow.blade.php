    ...
    <div class="row">
      <div class="col-lg-12">
          <ul class="pages">
            ...
            <li>
              <a href="{{ route('front.blog',$storename) }}">
                {{ $langg->lang18 }}
              </a>
            </li>
            <li>
                  ...
                  <div class="tag-social-link">
                    <div class="tag">
                      ...
                      @foreach(explode(',', $blog->tags) as $key => $tag)
                        <a href="{{ route('front.blogtags',[$storename,$tag]) }}">
        ...
        <div class="col-lg-4">
          <div class="blog-aside">
            <div class="serch-form">
              <form action="{{ route('front.blogsearch',$storename) }}">
            ...
            <div class="categori">
              ...
              <ul class="categori-list">
                ...
                <li>
                  <a href="{{ route('front.blogcategory',[$storename,$cat->slug]) }}"  {!! $cat->id == $blog->category_id ? 'class="active"':'' !!}>
                    <span>{{ $cat->name }}</span>
            ...
            <div class="archives">
              ...
              <ul class="archives-list">
                ...
                <li>
                  <a href="{{ route('front.blogarchive',[$storename,$key]) }}">
                    <span>{{ $key }}</span>
            ...
            <div class="tags">
              ...
              <ul class="tags-list">
                @foreach($tags as $tag)
                  @if(!empty($tag))
                  <li>
                    <a href="{{ route('front.blogtags',[$storename,$tag]) }}">{{ $tag }} </a>
                  </li>
                  @endif
                @endforeach
              </ul>
