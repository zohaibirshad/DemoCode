				...
				<div class="col-lg-12">
					...
					<ul class="pages">
						...
						<li>
							...
							<a href="{{ route('product.compare',$storename) }}">
									...
									<tbody>
										...
										<tr>
											...
											<td class="product-image-title c{{$product['item']['id']}}">
												...
												<a href="{{ route('front.product', [$storename,$product['item']['slug']]) }}">
										...
										<tr>
											...
											<td class="pro-price c{{$product['item']['id']}}">{{ App\Models\Product::find($product['item']['id'])->showPrice($storename) }}</td>
										...
										<tr>
											...
											<tr>
													...
													<td class="c{{$product['item']['id']}}">
															...
															<a href="{{ route('affiliate.product', [$storename,$product['item']['slug']]) }}" class="btn__bg">{{ $langg->lang251 }}</a>

															@else														

														

														<a href="javascript:;" data-href="{{ route('product.cart.add',[$storename,$product['item']['id']]) }}" class="btn__bg add-to-cart">{{ $langg->lang75 }}</a>

													<a href="{{ route('product.cart.quickadd',[$storename,$product['item']['id']]) }}" class="btn__bg">{{ $langg->lang251 }}</a>
										...
										<tr>
											...
											<td class="pro-remove c{{$product['item']['id']}}">
												...
												<i class="far fa-trash-alt compare-remove" data-href="{{ route('product.compare.remove',[$storename,$product['item']['id']]) }}" data-class="c{{$product['item']['id']}}"></i>
