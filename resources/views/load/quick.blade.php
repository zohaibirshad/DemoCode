...
<div class="right-area">
  <div class="product-info">
      <h4 class="product-name"><a target="_blank" href="{{ route('front.product',[$storename,$product->slug]) }}">{{ $product->name }}</a></h4>
      ...
      <div class="product-price">
          ...
          <p class="price"><span id="msizeprice">{{ $product->showPrice($storename) }}</span>
            <small><del>{{ $product->showPreviousPrice($storename) }}</del></small></p>
      ...
      <div class="info-meta-3">
          <ul class="meta-list">
            ...
            @endif
              ...
              <li class="addtocart">
                <a href="{{ route('affiliate.product', [$storename,$product->slug]) }}" target="_blank"><i
              ...
              @if(Auth::guard('web')->check())
                  <li class="favorite">
                      <a href="javascript:;" class="add-to-wish" data-href="{{ route('user-wishlist-add',[$storename,$product->id ]) }}"><i class="icofont-heart-alt"></i></a>
                  </li>
              @else
                  <li class="favorite">
              ...
              @endif
              <li class="compare">
                  <a href="javascript:;" class="add-to-compare" data-href="{{ route('product.compare.add',[$storename,$product->id]) }}"><i class="icofont-exchange"></i></a>
              </li>
          </ul>
