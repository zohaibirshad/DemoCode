...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ $langg->lang448 }} <a class="add-btn" href="{{ route('admin-prod-types',$storename) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('vendor-import-create',$storename) }}">{{ $langg->lang448 }}</a>
												</li>
											</ul>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="geniusform" action="{{route('vendor-import-store',$storename)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
                        					...
                        					@include('includes.admin.form-both')
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ $langg->lang707 }}" name="affiliate_link" required="">
