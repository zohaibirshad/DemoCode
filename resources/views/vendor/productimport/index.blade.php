...
@section('content')  
					...
					<div class="content-area">
						<div class="mr-breadcrumb">
							<div class="row">
								<div class="col-lg-12">
										<h4 class="heading">{{ $langg->lang449 }}</h4>
										<ul class="links">
											<li>
											...
											<li>
												<a href="javascript:;">{{ $langg->lang449 }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('vendor-import-datatables',$storename) }}',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'type', name: 'type' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" href="{{route('vendor-import-create',$storename)}}">'+
