              ...
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      ...
                      <ul class="links">
                        <li>
                          <a href="{{ route('vendor-dashboard',$storename) }}">{{ __('Dashboard') }}</a>
                        </li>
                      <li>r
                        <a href="{{ route('vendor-verify',$storename) }}">{{ __('Vendor Verification') }}</a>
                      </li>
                      </ul>
                  </div>
                </div>
...
<div class="alert alert-success validation" style="">
      ...
      @else
                        ...
                        @include('includes.admin.form-both')
                                ...
                                <form id="verifyform"  action="{{route('vendor-verify-submit',$storename)}}" method="POST" enctype="multipart/form-data">
                                  {{csrf_field()}}
