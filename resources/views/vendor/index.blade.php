                    ...
                    <div class="content-area">
                            ...
                            @if($user->checkWarning())
                                ...
                                <div class="alert alert-danger validation text-center">
                                        <h3>{{ $user->displayWarning() }} </h3> <a href="{{ route('vendor-warning',[$storename,$user->verifies()->where('admin_warning','=','1')->orderBy('id','desc')->first()->id]) }}"> {{$langg->lang803}} </a>
                                </div>
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="mycard bg1">
                                        <div class="left">
                                            ...
                                            <a href="{{route('vendor-order-index',$storename)}}" class="link">{{ $langg->lang471 }}</a>
                                        </div>
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="mycard bg4">
                                        <div class="left">
                                            ...
                                            <a href="{{route('vendor-prod-index',$storename)}}" class="link">{{ $langg->lang471 }}</a>
                                        </div>
                                        <div class="right d-flex align-self-center">
                                            <div class="icon">
                                ...
                                <div class="col-md-12 col-lg-6 col-xl-4">
                                    <div class="mycard bg6">
                                        <div class="left">
                                            ...
                                            <span class="number">{{ App\Models\Product::vendorConvertPrice($storename, App\Models\VendorOrder::where('user_id','=',$user->id)->where('status','=','completed')->sum('price') ) }}</span>
                                        </div>
                                        <div class="right d-flex align-self-center">
                                            <div class="icon">
