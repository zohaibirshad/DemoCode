              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('vendor-package-index',$storename) }}">{{ $langg->lang721 }}</a>
                      </li>
                    </ul>
                </div>
              </div>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('vendor-package-datatables',$storename) }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('vendor-package-create',$storename)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
