								...
								<div class="row">
									<div class="col-lg-12">
											...
											<ul class="links">
												...
												<li>
													<a href="{{ route('vendor-prod-import',$storename) }}">{{ $langg->lang450 }}</a>
												</li>
											</ul>
									</div>
								</div>
							...
							<div class="add-product-content">
								<div class="row">
									<div class="col-lg-12 p-5">
					                      ...
					                      <form id="geniusform" action="{{route('vendor-prod-importsubmit',$storename)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
