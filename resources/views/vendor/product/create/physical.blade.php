...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ $langg->lang629 }} <a class="add-btn" href="{{ route('vendor-prod-types',$storename) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
											<ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('vendor-prod-types',$storename) }}">{{ $langg->lang445 }}</a>
												...
												<li>
													<a href="{{ route('vendor-prod-physical-create',$storename) }}">{{ $langg->lang629 }}</a>
												</li>
											</ul>
									</div>
								</div>
