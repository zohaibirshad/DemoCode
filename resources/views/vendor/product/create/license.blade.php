...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ $langg->lang631 }} <a class="add-btn" href="{{ route('vendor-prod-types',$storename) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
											<ul class="links">
                      <li>
                      ...
                      <li>
                        <a href="{{ route('vendor-prod-index',$storename) }}">{{ $langg->lang446 }}</a>
                      </li>
                      <li>
                        <a href="{{ route('vendor-prod-types',$storename) }}">{{ $langg->lang445 }}</a>
                      </li>
												<li>
													<a href="{{ route('vendor-prod-license-create',$storename) }}">{{ $langg->lang631 }}</a>
												</li>
											</ul>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
										<div class="product-description">
					                      ...
					                      <form id="geniusform" action="{{route('vendor-prod-store',$storename)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
                        ...
                        @include('includes.vendor.form-both')  
													...
													<div class="col-lg-7">
															<select id="cat" name="category_id" required="">
																	<option value="">{{ $langg->lang691 }}</option>
						                                              @foreach($cats as $cat)
						                                                  <option data-href="{{ route('vendor-subcat-load',[$storename,$cat->id]) }}" value="{{ $cat->id }}">{{$cat->name}}</option>
						                                              @endforeach
						                                     </select>
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ $langg->lang701 }}" name="platform">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ $langg->lang702 }}" name="region">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" placeholder="{{ $langg->lang703 }}" name="licence_type">
													</div>
												</div>
