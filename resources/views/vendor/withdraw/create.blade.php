...
@section('content')
                        ...
                        <div class="content-area">
                         ...
                         <form id="geniusform" class="form-horizontal" action="{{route('vendor-wt-store',$storename)}}" method="POST" enctype="multipart/form-data">

                                                    {{ csrf_field() }}


                                <div class="item form-group">
                                    <label class="control-label col-sm-12" for="name"><b>{{ $langg->lang498 }} : {{ App\Models\Product::vendorConvertPrice($storename,Auth::user()->current_balance) }}</b></label>
                                </div>
