...
@section('content')
    <div class="content-area">
                        <div class="mr-breadcrumb">
                            <div class="row">
                                <div class="col-lg-12">
                                        <h4 class="heading">{{ $langg->lang549 }} <a class="add-btn" href="{{ route('vendor-order-index',$storename) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                                        <ul class="links">
                                            <li>
...
@endphp
                                        ...
                                        <div class="footer-area">
                                            <a href="{{ route('vendor-order-invoice',[$storename,$order->order_number]) }}" class="mybtn1"><i class="fas fa-eye"></i> {{ $langg->lang555 }}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                ...
                                @if($product['item']['user_id'] != 0)
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                @if(isset($user))
                                                <a target="_blank" href="{{route('admin-vendor-show',[$storename,$user->id])}}">{{$user->shop_name}}</a>
                                                @else
                                                {{ $langg->lang575 }}
                                                @endif
                                                @endif
                                            ...
                                            <td>
                                                ...
                                                @endphp
                                                @if(isset($user))
                                              <a target="_blank" href="{{ route('front.product', [$storename,$product['item']['slug']]) }}">{{mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,30,'utf-8').'...' : $product['item']['name']}}</a>
                                                @else
        ...
        <h4 class="modal-title d-inline-block">{{ $langg->lang577 }}</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    ...
                    <form method="POST" action="{{route('vendor-order-license',[$storename,$order->order_number])}}" id="edit-license" style="display: none;">
                        {{csrf_field()}}
