...
<div class="content-area">
                    <div class="mr-breadcrumb">
                        <div class="row">
                            <div class="col-lg-12">
                                <h4 class="heading">{{ $langg->lang586 }} <a class="add-btn" href="{{ route('vendor-order-show',[$storename,$order->order_number]) }}"><i class="fas fa-arrow-left"></i> {{ $langg->lang550 }}</a></h4>
                                <ul class="links">
                                    <li>
            ...
            <div class="invoice__title">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a class="btn  add-newProduct-btn print" href="{{route('vendor-order-print',[$storename,$order->order_number])}}"
                                    ...
                                    @if($product['item']['user_id'] == $user->id)
                                        ...
                                        <tr>
                                            <td width="50%">
                                                ...
                                                @if(isset($user))
                                                <a target="_blank"
                                                    href="{{ route('front.product', [$storename,$product['item']['slug']]) }}">{{ $product['item']['name']}}</a>
                                                @else
