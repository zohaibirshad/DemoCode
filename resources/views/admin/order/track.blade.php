                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="product-description">
                                            ...
                                            <input type="hidden" id="track-store" value="{{route('admin-order-track-store',$storename)}}">
                                            <form id="trackform" action="{{route('admin-order-track-store',$storename)}}" method="POST" enctype="multipart/form-data">
                                                {{csrf_field()}}
							...
							<div class="add-product-content">
								<div class="row">
                                    ...
                                    <div class="table-responsive show-table ml-3 mr-3">
                                        <table class="table" id="track-load" data-href={{ route('admin-order-track-load',[$storename,$order->id]) }}>
                                            <tr>
                                                <th>{{ __("Title") }}</th>
                                                <th>{{ __("Details") }}</th>
                                                <th>{{ __("Date") }}</th>
                                            ...
                                            <tr data-id="{{ $track->id }}">
                                                ...
                                                <td>
                                                    <div class="action-list">
                                                        <a data-href="{{ route('admin-order-track-update',[$storename,$track->id]) }}" class="track-edit"> <i class="fas fa-edit"></i>Edit</a>
                                                        <a href="javascript:;" data-href="{{ route('admin-order-track-delete',[$storename,$track->id]) }}" class="track-delete"><i class="fas fa-trash-alt"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
