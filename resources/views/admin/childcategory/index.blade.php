								...
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												...
												<a href="{{ route('admin-childcat-index',$storename) }}">{{ __('Child Categories') }}</a>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               ajax: '{{ route('admin-childcat-datatables',$storename) }}',
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	...
        	'<a class="add-btn" data-href="{{route('admin-childcat-create',$storename)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
