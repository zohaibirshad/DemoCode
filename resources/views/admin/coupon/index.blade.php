							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('admin-coupon-index',$storename) }}">{{ __('Coupons') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-coupon-datatables',$storename) }}',
               columns: [
                        { data: 'code', name: 'code' },
                        { data: 'type', name: 'type' },
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	'<a class="add-btn" data-href="{{route('admin-coupon-create',$storename)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
