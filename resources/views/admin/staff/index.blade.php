							...
							<div class="row">
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												<a href="{{ route('admin-staff-index',$storename) }}">{{ __('Manage Staffs') }}</a>
											</li>
										</ul>
								</div>
							</div>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-staff-datatables',$storename) }}',
               columns: [
                        { data: 'name', name: 'name' },
        ...
        $(".btn-area").append('<div class="col-sm-4 text-right">'+
        	'<a class="add-btn" data-href="{{route('admin-staff-create',$storename)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
