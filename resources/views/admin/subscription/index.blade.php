              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-subscription-index',$storename) }}">{{ __("Vendor Subscription Plans") }}</a>
                      </li>
                    </ul>
                </div>
              </div>
...
{{-- DATA TABLE --}}
    ...
    var table = $('#geniustable').DataTable({
         ordering: false,
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-subscription-datatables',$storename) }}',
               columns: [
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
          '<a class="add-btn" data-href="{{route('admin-subscription-create',$storename)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
