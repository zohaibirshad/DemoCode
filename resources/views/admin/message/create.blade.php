        ...
        <div class="col-lg-12">
            ...
            <h4 class="heading">{{ __('Conversation with') }} {{$conv->user->name}} <a class="add-btn" href="{{ url()->previous() }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                <ul class="links">
                    ...
                    <li>
                        <a href="{{ route('admin-message-index',$storename) }}">{{ __('Messages') }}</a>
                    </li>
                    <li>
...
<div class="order-table-wrap support-ticket-wrapper ">
                        ...
                        @include('includes.admin.form-both')  
                                ...
                                <div class="single-reply-area user">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            @endif
                                                    <a target="_blank" class="d-block profile-btn" href="{{ route('admin-user-show',[$storename,$message->conversation->user->id]) }}" class="d-block">{{ __('View Profile') }}</a>
                            ...
                            <div class="panel-footer">
                                <form id="messageform" action="{{route('admin-message-store',$storename)}}" data-href="{{ route('admin-message-load',[$storename,$conv->id]) }}" method="POST">
                                    {{csrf_field()}}
