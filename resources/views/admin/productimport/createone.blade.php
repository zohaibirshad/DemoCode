	...
	<div class="mr-breadcrumb">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h4 class="heading">{{ __("Affiliate Product") }} <a class="add-btn" href="{{ route('admin-prod-types',$storename) }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
				...
				<ul class="links">
					...
					<li>
						...
						<a href="{{ route('admin-import-create',$storename) }}">{{ __("Add Affiliate Product") }}</a>
			...
			<div class="col-lg-12">
				...
				<div class="product-description">
					...
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('admin-import-store',$storename)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									...
									<input name="price" step="0.01" type="number" class="input-field" placeholder="{{ __("e.g 20") }}" required="" min="0">
