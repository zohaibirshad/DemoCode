			...
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						...
						<a href="{{ route('admin.dashboard',$storename) }}">{{ ("Dashboard") }} </a>
					...
					<li>
						...
						<a href="{{ route('admin-import-index',$storename) }}">{{ __("All Products") }}</a>
			...
			<div class="col-lg-12">
				...
				<div class="product-description">
					...
					<div class="body-area">
						...
						<form id="geniusform" action="{{route('admin-import-update',[$storename,$data->id])}}" method="POST" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="row">
										...
										<div class="col-lg-7">
											...
											<select id="cat" name="category_id" required="">
												...
												<option data-href="{{ route('admin-subcat-load',[$cat->id,$storename]) }}" value="{{$cat->id}}" {{$cat->id == $data->category_id ? "selected":""}} >{{$cat->name}}</option>
									...
									<div class="row">
										...
										<div class="col-lg-7">
											...
											<select id="subcat" name="subcategory_id">
												...
												<option data-href="{{ route('admin-childcat-load',[$sub->id,$storename]) }}" value="{{$sub->id}}" >{{$sub->name}}</option>
												...
												<option data-href="{{ route('admin-childcat-load',[$sub->id,$storename]) }}" value="{{$sub->id}}" {{$sub->id == $data->subcategory_id ? "selected":""}} >{{$sub->name}}</option>
									...
									<div class="row">
										...
										<div class="col-lg-7">
											...
											<input name="price" step="0.01" type="number" class="input-field" placeholder="{{ __("e.g 20") }}" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
		...
		setTimeout(
			...
			function() {
				...
				$.ajax({
					...
					url: "{{route('admin-prod-upload-update',[$data->id,$storename])}}",
