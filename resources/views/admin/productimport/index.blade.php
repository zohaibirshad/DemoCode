								...
								<div class="col-lg-12">
										...
										<ul class="links">
											...
											<li>
												...
												<a href="{{ route('admin-prod-index',$storename) }}">{{ __("Affiliate Products") }}</a>
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
		...
		var table = $('#geniustable').DataTable({
               ...
               ajax: '{{ route('admin-import-datatables',$storename) }}',
        ...
        $(".btn-area").append('<div class="col-sm-4 table-contents">'+
        	...
        	'<a class="add-btn" href="{{route('admin-import-create',$storename)}}">'+
