...
<div class="content-area">
              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-social-index',$storename) }}">{{ __('Social Links') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
            ...
            <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
              <form id="geniusform" class="form-horizontal" action="{{ route('admin-social-update-all',$storename) }}" method="POST">   
              {{ csrf_field() }}
