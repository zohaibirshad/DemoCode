								...
								<div class="row">
									<div class="col-lg-12">
											...
											<ul class="links">
												...
												<li>
													<a href="{{ route('admin.profile', $storename) }}">{{ __('Edit Profile') }} </a>
												</li>
											</ul>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-lg-12">
				                        ...
				                        <div class="gocover" style="background: url({{asset('assets/images/'.$gs->admin_loader)}}) no-repeat scroll center center rgba(45, 45, 45, 0.5);"></div>
											<form id="geniusform" action="{{ route('admin.profile.update', $storename) }}" method="POST" enctype="multipart/form-data">
												{{csrf_field()}}
