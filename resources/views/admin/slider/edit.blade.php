...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Edit Slider') }} <a class="add-btn" href="{{route('admin-sl-index',$storename)}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-sl-index',$storename) }}">{{ __('Sliders') }}</a>
                        </li>
                        <li>
                          <a href="{{route('admin-sl-edit',[$storename,$data->id])}}">{{ __('Edit') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-sl-update',[$storename,$data->id])}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                              <select  name="position" required="">
                                  ...
                                  <option value="slide-one" {{ $data->position == 'slide-one' ? 'selected':'' }}>{{ __('Left') }}</option>
                                  <option value="slide-two" {{ $data->position  == 'slide-two' ? 'selected':'' }}>{{ __('Center') }}</option>
                                  <option value="slide-three" {{ $data->position  == 'slide-three' ? 'selected':'' }}>{{ __('Right') }}</option>
                                </select>
                          </div>
                        </div>
