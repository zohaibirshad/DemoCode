                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-gs-popup',$storename) }}">{{ __('Popup Banner') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_popup  == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-ispopup',[$storename,1])}}" {{ $gs->is_popup == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-ispopup',[$storename,0])}}" {{ $gs->is_popup == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
