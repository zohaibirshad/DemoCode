      ...
      <div class="col-lg-12">
        ...
        <ul class="links">
          ...
          <li>
            ...
            <a href="{{ route('admin-gs-payments',$storename) }}">{{ __('Payment Informations') }}</a>
      ...
      <div class="col-lg-12">
        ...
        <div class="product-description">
          ...
          <div class="body-area">
            ...
            <form action="{{ route('admin-gs-update-payment',$storename) }}" id="geniusform" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="action-list">
                    ...
                    <select class="process select droplinks {{ $gs->stripe_check == 1 ? 'drop-success' : 'drop-danger' }}">
                      ...
                      <option data-val="1" value="{{route('admin-gs-stripe',[$storename,1])}}" {{ $gs->stripe_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                      <option data-val="0" value="{{route('admin-gs-stripe',[$storename,0])}}" {{ $gs->stripe_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="action-list">
                    ...
                    <select class="process select droplinks {{ $gs->is_amazon == 1 ? 'drop-success' : 'drop-danger' }}">

                      <option data-val="1" value="{{route('admin-gs-amazon',[$storename,1])}}" {{ $gs->is_amazon == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                      <option data-val="0" value="{{route('admin-gs-amazon',[$storename,0])}}" {{ $gs->is_amazon == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="left-area">
                    ...
                    <h4 class="heading">{{ __('Amazon Client ID') }} *
                ...
                <div class="col-lg-6">
                  ...
                  <input type="text" class="input-field" placeholder="{{ __('Amazon Client ID') }}" name="amazon_client_id" value="{{ $gs->amazon_client_id }}" required="">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="left-area">
                    ...
                    <h4 class="heading">{{ __('Amazon Seller ID') }} *
                ...
                <div class="col-lg-6">
                  ...
                  <input type="text" class="input-field" placeholder="{{ __('Amazon Seller ID') }}" name="amazon_seller_id" value="{{ $gs->amazon_seller_id }}" required="">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="action-list">
                    ...
                    <select class="process select droplinks {{ $gs->paypal_check == 1 ? 'drop-success' : 'drop-danger' }}">
                      ...
                      <option data-val="1" value="{{route('admin-gs-paypal',[$storename,1])}}" {{ $gs->paypal_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                      <option data-val="0" value="{{route('admin-gs-paypal',[$storename,0])}}" {{ $gs->paypal_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="action-list">
                                    ...
                                    <select class="process select droplinks {{ $gs->is_instamojo == 1 ? 'drop-success' : 'drop-danger' }}">
                                      ...
                                      <option data-val="1" value="{{route('admin-gs-instamojo',[$storename,1])}}" {{ $gs->is_instamojo == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                      <option data-val="0" value="{{route('admin-gs-instamojo',[$storename,0])}}" {{ $gs->is_instamojo == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                            ...
                            <div class="col-lg-6">
                              ...
                              <div class="action-list">
                                ...
                                <select class="process select droplinks {{ $gs->is_paystack == 1 ? 'drop-success' : 'drop-danger' }}">
                                  ...
                                  <option data-val="1" value="{{route('admin-gs-paystack',[$storename,1])}}" {{ $gs->is_paystack == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                  <option data-val="0" value="{{route('admin-gs-paystack',[$storename,0])}}" {{ $gs->is_paystack == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="action-list">
                                    ...
                                    <select class="process select droplinks {{ $gs->is_paytm == 1 ? 'drop-success' : 'drop-danger' }}">
                                      ...
                                      <option data-val="1" value="{{route('admin-gs-paytm',[$storename,1])}}" {{ $gs->is_paytm == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                      <option data-val="0" value="{{route('admin-gs-paytm',[$storename,0])}}" {{ $gs->is_paytm == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="action-list">
                              ...
                              <select class="process select droplinks {{ $gs->is_molly == 1 ? 'drop-success' : 'drop-danger' }}">
                                ...
                                <option data-val="1" value="{{route('admin-gs-molly',[$storename,1])}}" {{ $gs->is_molly == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                <option data-val="0" value="{{route('admin-gs-molly',[$storename,0])}}" {{ $gs->is_molly == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="action-list">
                              ...
                              <select class="process select droplinks {{ $gs->is_razorpay == 1 ? 'drop-success' : 'drop-danger' }}">
                                ...
                                <option data-val="1" value="{{route('admin-gs-razor',[$storename,1])}}" {{ $gs->is_razorpay == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                <option data-val="0" value="{{route('admin-gs-razor',[$storename,0])}}" {{ $gs->is_razorpay == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="action-list">
                              ...
                              <select class="process select droplinks {{ $gs->guest_checkout == 1 ? 'drop-success' : 'drop-danger' }}">
                                ...
                                <option data-val="1" value="{{route('admin-gs-guest',[$storename,1])}}" {{ $gs->guest_checkout == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                <option data-val="0" value="{{route('admin-gs-guest',[$storename,0])}}" {{ $gs->guest_checkout == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                          ...
                          <div class="col-lg-6">
                            ...
                            <div class="action-list">
                              ...
                              <select class="process select droplinks {{ $gs->cod_check == 1 ? 'drop-success' : 'drop-danger' }}">
                                ...
                                <option data-val="1" value="{{route('admin-gs-cod',[$storename,1])}}" {{ $gs->cod_check == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>

                                <option data-val="0" value="{{route('admin-gs-cod',[$storename,0])}}" {{ $gs->cod_check == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
