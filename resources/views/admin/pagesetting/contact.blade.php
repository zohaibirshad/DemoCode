                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-ps-contact',$storename) }}">{{ __('Contact Us Page') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <form id="geniusform" action="{{ route('admin-ps-update',$storename) }}" method="POST" enctype="multipart/form-data">
                          {{ csrf_field() }}
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->is_contact == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-iscontact',[$storename,1])}}" {{ $gs->is_contact == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-iscontact',[$storename,0])}}" {{ $gs->is_contact == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
