                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusformdata" action="{{route('admin-shipping-update',[$storename,$data->id])}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-7">
                            <input type="number" class="input-field" name="price" placeholder="{{ __('Price') }}" required="" value="{{ $data->price }}" min="0" step="0.01">
                          </div>
                        </div>
