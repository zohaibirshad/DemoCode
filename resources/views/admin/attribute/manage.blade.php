      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-12">
            ...
            <h4 class="heading d-inline-block">
              ...
              href="{{ route('admin-cat-index',$storename) }}"

              @elseif (request()->input('type') == 'subcategory')

              href="{{ route('admin-subcat-index',$storename) }}"

              @elseif (request()->input('type') == 'childcategory')

              href="{{ route('admin-childcat-index',$storename) }}"
            ...
            <div class="add-product-content">
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-md-8">
                    ...
                    @if ($data['type'] == 'subcategory' || $data['type'] == 'childcategory')
                      ...
                      @php
                        ...
                        } elseif ($data['type'] == 'childcategory') {
                    ...
                    @if ($data['type'] == 'childcategory')

                      @if ($data['data']->subcategory->attributes()->count() > 0)

                        @foreach ($data['data']->subcategory->attributes as $key => $attribute)
                    ...
                    @foreach ($data['data']->attributes as $attribute)
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <a href="{{route('admin-attr-edit', [$storename ,$attribute->id ])}}" class="btn btn-warning"><i class="fas fa-edit"></i></a>

                          <form class="d-inline-block" action="{{ route('admin-attr-delete', [$storename ,$attribute->id]) }}" method="get">
