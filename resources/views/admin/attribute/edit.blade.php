            ...
            <div class="add-product-content">
              ...
              <div class="row">
                ...
                <div class="col-md-6 offset-md-3">
                  ...
                  <form id="geniusform" action="{{route('admin-attr-update', [$storename,$data['attr']->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="col-md-12">
                          ...
                          <div class="form-group">
                               ...
                               <div class="">
                                 ...
                                 <input type="text" class="input-field" name="name" value="{{$data['attr']->name}}" placeholder="{{__('Enter Name')}}" required>
                      ...
                      <div class="row mt-1">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <input type="checkbox" id="priceStatus1" name="price_status" class="custom-control-input" {{ $data['attr']->price_status == 1 ? 'checked' : '' }} value="1">
                      ...
                      <div class="row mb-4">
                        ...
                        <div class="col-lg-12">
                          ...
                          <div class="custom-control custom-checkbox">
                            ...
                            <input type="checkbox" id="detailsStatus1" name="details_status" class="custom-control-input" {{ $data['attr']->details_status == 1 ? 'checked' : '' }} value="1">
  ...
  <script>
    ...
    var app = new Vue({
      ...
      created() {
        ...
        $.get("{{route('admin-attr-options', [$storename,$data['attr']->id])}}", (data) => {
