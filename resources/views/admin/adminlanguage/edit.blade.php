              ...
              <div class="mr-breadcrumb">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                      ...
                      <h4 class="heading">{{ __('Edit Language') }} <a class="add-btn" href="{{route('admin-tlang-index',$storename)}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      ...
                      <ul class="links">
                        ...
                        <li>
                          ...
                          <a href="{{ route('admin-tlang-edit',[$data->id,$storename]) }}">{{ __('Edit') }}</a>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-tlang-update',[$storename,$data->id])}}" method="POST" enctype="multipart/form-data">
