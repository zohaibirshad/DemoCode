...
@section('content')
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading">{{ __('Add Language') }} <a class="add-btn" href="{{route('admin-tlang-index',$storename)}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="{{ route('admin-tlang-index',$storename) }}">{{ __('Admin Panel Language') }}</a>
                        </li>
                        <li>
                          <a href="{{ route('admin-tlang-create',$storename) }}">{{ __('Add Language') }}</a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-tlang-create',$storename)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                            ...
                            <div class="featured-keyword-area">
                              ...
                              <div class="lang-tag-top-filds" id="lang-section">
                                ...
                                <div class="lang-area">
                                  ...
                                  <div class="row">
                                    <div class="col-lg-6">
                                      <textarea name="keys[]" class="input-field" placeholder="Enter Language Key" required="">Top Small Banners</textarea>
                                    </div>

                                    <div class="col-lg-6">
                                      <textarea  name="values[]" class="input-field" placeholder="Enter Language Value" required="">Top Small Banners</textarea>
                                    </div>
                                  </div>
                                </div>
