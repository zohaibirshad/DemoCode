...
@section('content')
            ...
            <div class="content-area">
                <div class="mr-breadcrumb">
                    <div class="row">
                      <div class="col-lg-12">
                          <h4 class="heading">{{ __('Add Role') }} <a class="add-btn" href="{{route('admin-role-index',$storename)}}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
                          <ul class="links">
                            <li>
                            ...
                            <li>
                              <a href="{{ route('admin-role-create',$storename) }}">{{ __('Add Role') }}</a>
                            </li>
                          </ul>
                      </div>
                    </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-role-create',$storename)}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
