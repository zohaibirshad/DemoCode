			...
			<div class="col-lg-12">
				...
				<ul class="links">
					...
					<li>
						...
						<a href="{{ route('admin-cat-index',$storename) }}">{{ __('Main Categories') }}</a>
...
<script type="text/javascript">
	...
	var table = $('#geniustable').DataTable({
		...
		ajax: '{{ route('admin-cat-datatables',$storename) }}',
	...
	$(function() {
		...
		$(".btn-area").append('<div class="col-sm-4 table-contents">'+
			...
			'<a class="add-btn" data-href="{{route('admin-cat-create',$storename)}}" id="add-data" data-toggle="modal" data-target="#modal1">'+
