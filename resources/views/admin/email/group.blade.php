              ...
              <div class="row">
                <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-group-show',$storename) }}">{{ __('Group Email') }}</a>
                      </li>
                    </ul>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="{{route('admin-group-submit',$storename)}}" method="POST" enctype="multipart/form-data">
