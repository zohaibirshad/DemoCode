                ...
                <div class="row">
                  <div class="col-lg-12">
                    ...
                    <ul class="links">
                      ...
                      <li>
                        <a href="{{ route('admin-seotool-analytics',$storename) }}">{{ __('Google Analytics') }}</a>
                      </li>
                    </ul>
                  </div>
                </div>
                  ...
                  <div class="col-lg-12">
                    <div class="product-description">
                      <div class="body-area">
                        ...
                        <form id="geniusform" action="{{ route('admin-seotool-analytics-update',$storename) }}" method="POST" enctype="multipart/form-data">
                          {{csrf_field()}}
