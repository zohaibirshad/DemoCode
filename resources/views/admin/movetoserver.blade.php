									...
									<div class="col-lg-12">
											...
											<ul class="links">
												...
												<li>
													...
													<a href="{{ route('admin-generate-backup',$storename) }}">{{ __('Generate BackUp') }} </a>
                        ...
                        @include('includes.admin.form-both')
												...
												<div style="padding: 10px;" class="text-center">
													...
													@else
														...
														<span id="bkupData"><a href="{{$bkuplink}}">{{$chk}}</a><a href="{{route('admin-clear-backup',$storename)}}"> <i class="fa fa-times-circle"></i></a></span>
	...
	<script type="text/javascript">
        ...
        $("#generateBkup").click(function(){
            ...
            $.ajax({
                ...
                url: "{{url($storename.'/admin/check/movescript')}}",
