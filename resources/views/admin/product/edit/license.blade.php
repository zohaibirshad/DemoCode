...
@section('content')
									...
									<div class="col-lg-12">
											...
											<ul class="links">
												...
												<li>
													...
													<a href="{{ route('admin-prod-index',$storename) }}">{{ __("Products") }} </a>
								...
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<div class="product-description">
					                      ...
					                      <form id="geniusform" action="{{route('admin-prod-update',[$storename,$data->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        @include('includes.admin.form-both')  
                                              ...
                                              @foreach($cats as $cat)
                                                  ...
                                                  <option data-href="{{ route('admin-subcat-load',[$storename,$cat->id]) }}" value="{{$cat->id}}" {{$cat->id == $data->category_id ? "selected":""}} >{{$cat->name}}</option>
				...
				<i class="icofont-upload-alt"></i> {{ __("Upload Image Here") }}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														...
														<input name="price" type="number" class="input-field" placeholder="{{ __("e.g 20") }}" step="0.01" value="{{round($data->price * $sign->value , 2)}}" required="" min="0">
 ...
 setTimeout(
    ...
    function() {
      ...
      $.ajax({
        ...
        url: "{{route('admin-prod-upload-update',[$storename,$data->id])}}",
