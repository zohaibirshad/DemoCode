								...
								<div class="row">
									<div class="col-lg-12">
											...
											<li>
												...
												<li>
													<a href="{{ route('admin-prod-import',$storename) }}">{{ __("Bulk Upload") }}</a>
												</li>
											</ul>
									</div>
								</div>
							...
							<div class="add-product-content">
								<div class="row">
									<div class="col-lg-12 p-5">
					                      ...
					                      <form id="geniusform" action="{{route('admin-prod-importsubmit',$storename)}}" method="POST" enctype="multipart/form-data">
					                        {{csrf_field()}}
