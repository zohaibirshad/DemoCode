...
@section('content')
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading">{{ __("Digital Product") }} <a class="add-btn" href="{{ route('admin-prod-types',$storename) }}"><i class="fas fa-arrow-left"></i> {{ __("Back") }}</a></h4>
											<ul class="links">
												<li>
											...
											<li>
												...
												<li>
													<a href="{{ route('admin-prod-digital-create',$storename) }}">{{ __("Digital Product") }}</a>
												</li>
											</ul>
									</div>
								</div>
