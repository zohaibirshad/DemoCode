	...
	<div class="mr-breadcrumb">
		...
		<div class="row">
			...
			<div class="col-lg-12">
				...
				<h4 class="heading">{{ __('Physical Product') }} <a class="add-btn" href="{{ route('admin-prod-types',$storename) }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
				...
				<ul class="links">
					...
					<li>
						...
						<a href="{{ route('admin-prod-index',$storename) }}">{{ __('All Products') }}</a>

					</li>

					<li>

						<a href="{{ route('admin-prod-types',$storename) }}">{{ __('Add Product') }}</a>

					</li>

					<li>

						<a href="{{ route('admin-prod-physical-create',$storename) }}">{{ __('Physical Product') }}</a>
