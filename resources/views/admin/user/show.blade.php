                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                        ...
                                        <ul class="links">
                                            ...
                                            <li>
                                                <a href="{{ route('admin-user-index',$storename) }}">{{ __("Customers") }}</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('admin-user-show',[$storename,$data->id]) }}">{{ __("Details") }}</a>
                                            </li>
                                        </ul>
                                </div>
                            </div>
                                                        ...
                                                        <div class="table-responsive">
                                                                <table id="example2" class="table table-hover dt-responsive" cellspacing="0" width="100%">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
            <td><a href="{{ route('admin-order-invoice',[$storename,$order->id]) }}">{{sprintf("%'.08d", $order->id)}}</a></td>
                                                                            ...
                                                                            <td>{{ $order->status }}</td>
                                                                            <td>
                                                                                <a href=" {{ route('admin-order-show',[$storename,$order->id]) }}" class="view-details">
