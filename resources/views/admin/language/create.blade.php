  ...
  <div class="mr-breadcrumb">
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <h4 class="heading">{{ __('Add Language') }} <a class="add-btn" href="{{route('admin-lang-index',$storename)}}"><i
        ...
        <ul class="links">
          ...
          <li>
            ...
            <a href="{{ route('admin-lang-create',$storename) }}">{{ __('Add Language') }}</a>
      ...
      <div class="col-lg-12">
        ...
        <div class="product-description">
          ...
          <div class="body-area">
            ...
            <form id="geniusform" action="{{route('admin-lang-create',$storename)}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-4">
                          ...
                          <div class="left-area">
                            ...
                            <h4 class="heading">Oops Something Goes Went Message *</h4>
                        ...
                        <div class="col-lg-7">
                          ...
                          <input type="text" class="input-field" placeholder="Oops Something Went Wrong !!"

                            name="something_wrong" value="Oops Something Went Wrong !!" required="">
