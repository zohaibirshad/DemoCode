						...
						<div class="order-history">
							...
							<div class="header-area">
								...
								<h4 class="title">
									...
									{{ $langg->lang376 }} <a data-toggle="modal" data-target="#vendorform" class="mybtn1" href="javascript:;"> <i class="fas fa-envelope"></i> {{ $langg->lang377 }}</a>
                        ...
                        @foreach($convs as $conv)
                          ...
                          <tr class="conv">
                            ...
                            <td>
                              ...
                              <a href="{{route('user-message-show',[$storename,$conv->id])}}" class="link view"><i class="fa fa-eye"></i></a>

                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" data-href="{{route('user-message-delete1',[$storename,$conv->id])}}"class="link remove"><i class="fa fa-trash"></i></a>
...
<script type="text/javascript">
     ...
     $.ajax({
        ...
        if(data == 0)
          ...
          toastr.error("User not found with that email.");
