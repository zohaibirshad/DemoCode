                    ...
                    <div class="order-details">
                        ...
                        <div class="view-order-page">
                            ...
                            <div class="print-order text-right">
                                <a href="{{route('user-order-print',[$storename,$order->id])}}" target="_blank"
                            ...
                            <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if(isset($user))
                                                <a target="_blank"
                                                    href="{{ route('front.product', [$storename,$product['item']['slug']]) }}">{{mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,30,'utf-8').'...' : $product['item']['name']}}</a>
                                                @else
                                                <a target="_blank"
                                                    href="{{ route('front.product', [$storename,$product['item']['slug']]) }}">{{mb_strlen($product['item']['name'],'utf-8') > 30 ? mb_substr($product['item']['name'],0,30,'utf-8').'...' : $product['item']['name']}}</a>
                                                @endif
                                                ...
                                                <a href="{{ route('user-order-download',[$storename,'slug' => $order->order_number , 'id' => $product['item']['id']]) }}"
                                ...
                                <div class="edit-account-info-div">
                                    <div class="form-group">
                                        <a class="back-btn" href="{{ route('user-orders',$storename) }}">{{ $langg->lang318 }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
