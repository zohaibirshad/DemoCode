...
<div class="account-info">
                            ...
                            <div class="header-area">
                                ...
                                <h4 class="title">
                                    ...
                                    {{ $langg->lang409 }} <a class="mybtn1" href="{{route('user-package',$storename)}}"> <i class="fas fa-arrow-left"></i> {{ $langg->lang410 }}</a>
                            ...
                            <div class="pack-details">
                                ...
                                <br>
                                        ...
                                        <form id="subscribe-form" class="pay-form" action="{{route('user-vendor-request-submit',$storename)}}" method="POST">
        ...
        $(document).on('submit','#paystack-form',function(e){
            ...
            var val = $('#sub').val();
                ...
                {            
                    ...
                    $.get('{{ route('user.paystack.check',$storename).'?shop_name=' }}'+$('#shop-name').val(), function(data, status){
...
<script type="text/javascript">
        ...
        function meThods(val) {
            ...
            var action1 = "{{route('user.paypal.submit',$storename)}}";

            var action2 = "{{route('user.stripe.submit',$storename)}}";

            var action3 = "{{route('user.instamojo.submit',$storename)}}";

            var action4 = "{{route('user.paystack.submit',$storename)}}";

            var action5 = "{{route('user.molly.submit',$storename)}}";

            var action6 = "{{route('user.paytm.submit',$storename)}}";

            var action7 = "{{route('user.razorpay.submit',$storename)}}";
