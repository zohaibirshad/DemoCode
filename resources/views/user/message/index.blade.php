                        ...
                        @foreach($convs as $conv)
                          ...
                          <tr class="conv">
                            ...
                            <td>
                              ...
                              <a href="{{route('user-message',[$storename,$conv->id])}}" class="link view"><i class="fa fa-eye"></i></a>

                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" data-href="{{route('user-message-delete',[$storename,$conv->id])}}" class="link remove"><i class="fa fa-trash"></i></a>
...
<script type="text/javascript">
     ...
     $.ajax({
            ...
            url: "{{URL::to($storename.'/user/user/contact')}}",
