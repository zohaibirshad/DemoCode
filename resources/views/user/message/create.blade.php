        ...
        <div class="col-lg-8">
					<div class="user-profile-details">
						<div class="order-history">
                            ...
                            @else
                            {{$conv->sent->name}}
                            @endif <a  class="mybtn1" href="{{ route('user-messages',$storename) }}"> <i class="fas fa-arrow-left"></i> {{ $langg->lang373 }}</a>
								</h4>
							</div>
...
<div class="support-ticket-wrapper ">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-footer">
                        <form id="messageform" data-href="{{ route('user-vendor-message-load',[$storename,$conv->id]) }}" action="{{route('user-message-post',$storename)}}" method="POST">
                            {{csrf_field()}}
