					...
					<div class="user-profile-details">
                        ...
                        @foreach($favorites as $vendor)
                          ...
                          <tr class="conv">
                            ...
                            <td>
                              <a target="_blank" href="{{route('front.vendor',[$storename,str_replace(' ', '-',($seller->shop_name)) ] ) }}" class="link view"><i class="fa fa-eye"></i></a>
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" data-href="{{route('user-favorite-delete',[$storename,$vendor->id])}}" class="link remove"><i class="fa fa-trash"></i></a>
                            </td>
