...
Route::prefix('admin')->group(function() {
  ...
  Route::group(['middleware'=>['permissions:orders','storename.auth']],function(){
...
Route::group(['middleware'=>'permissions:products'],function(){
  ...
  Route::group(['middleware'=>['permissions:products','storename.auth']],function(){
...
Route::group(['middleware'=>'permissions:affilate_products'],function(){
  Route::get('/products/import/datatables', 'Admin\ImportController@datatables')->name('admin-import-datatables');
  Route::get('/products/import/datatables', 'Admin\ImportController@datatables')->name('admin-import-datatables');
});

  Route::group(['middleware'=>['permissions:affilate_products','storename.auth']],function(){
    ...
    Route::get('/products/ali-express/import', 'Admin\ImportController@ali_express_import')->name('products-ali-express-import');

    Route::post('products-ali-express-fetch', 'Admin\ImportController@ali_express_product_fetch')->name('products-ali-express-fetch');
  ...
  Route::group(['middleware'=>['permissions:customers','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:vendors','storename.auth']],function(){
...
// Verification Section Ends
  ...
  Route::group(['middleware'=>['permissions:vendor_subscription_plans','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:categories','storename.auth']],function(){
  ...
  //------------ ADMIN PRODUCT DISCUSSION SECTION ------------
    ...
    Route::group(['middleware'=>['permissions:product_discussion','storename.auth']],function(){
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::group(['middleware'=>['permissions:set_coupons','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:messages','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:general_settings','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:home_page_settings','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:menu_page_settings','storename.auth']],function(){
...
//------------ ADMIN MENU PAGE SETTINGS SECTION ENDS ------------
  ...
  Route::group(['middleware'=>['permissions:emails_settings','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:payment_settings','storename.auth']],function(){
...
// Payment Informations
  ...
  Route::get('/general-settings/amazon/{status}', 'Admin\GeneralSettingController@amazon')->name('admin-gs-amazon');
...
// Currency Settings
  ...
  Route::group(['middleware'=>['permissions:language_settings','storename.auth']],function(){
  ...
  Route::get('/seotools/pixel', 'Admin\SeoToolController@pixel')->name('admin-seotool-pixel');

  Route::post('/seotools/pixel/update', 'Admin\SeoToolController@pixelupdate')->name('admin-seotool-pixel-update');
  ...
  Route::group(['middleware'=>['permissions:manage_staffs','storename.auth']],function(){
  ...
  Route::group(['middleware'=>['permissions:subscribers','storename.auth']],function(){
...
Route::group(['middleware'=>['permissions:super','storename.auth']],function(){
  ...
  Route::get('/cache/clear', function($storename) {
    ...
    return redirect()->route('admin.dashboard',$storename)->with('cache','System Cache Has Been Removed.');
...
//   Route::get('/checkout/',function(){ return view('front.checkout');})->name('front.checkout');
  ...
  Route::get('amazon/checkout/', 'Front\AmazonCheckoutController@index');

  Route::post('amazon/checkout/', 'Front\AmazonCheckoutController@amazon_checkout')->name('amazon-checkout');
