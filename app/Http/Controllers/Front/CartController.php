...
class CartController extends Controller
{
    ...
    public function cart($storename)
    {
        $this->code_image();
        if (!Session::has('cart')) {
            return view('front.cart',compact('storename'));
        }
        ...
        return view('front.cart', compact('products','totalPrice','mainTotal','tx','storename')); 
    }

    public function cartview($storename)
    {

        return view('load.cart',compact('storename')); 
    }

   public function addtocart($storename,$id)
    {
        $prod = Product::where('storename',$storename)->where('id','=',$id)->first(['id','user_id','slug','name','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
        ...
        {
            return redirect()->route('front.cart',$storename);
        }
   ...
   public function addcart($storename,$id)
    {
        $prod = Product::where('storename',$storename)->where('id','=',$id)->first(['id','user_id','slug','name','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
    ...
    public function addnumcart($storename)
    {
        $id = $_GET['id'];
        $qty = $_GET['qty'];
    ...
    public function addtonumcart($storename)
    {
        $id = $_GET['id'];
        $qty = $_GET['qty'];
        $size = str_replace(' ','-',$_GET['size']);
    ...
    public function addbyone($storename)
    {
        if (Session::has('coupon')) {
            Session::forget('coupon');
        }
    ...
    public function upcolor($storename)
    {
         $id = $_GET['id'];
         $color = $_GET['color'];
        $prod = Product::where('id','=',$id)->first(['id','user_id','slug','name','photo','size','size_qty','size_price','color','price','stock','type','file','link','license','license_qty','measure','whole_sell_qty','whole_sell_discount','attributes']);
    ...
    public function removecart($storename,$id)
    {
        $gs = Generalsetting::where('storename',$storename)->first();
        if (Session::has('currency')) 
        {
    ...
    public function coupon($storename)
    {
        $gs = Generalsetting::where('storename',$storename)->first();
        $code = $_GET['code'];
        ...
        $coupon = Coupon::where('storename',$storename)->where('code','=',$code)->first();
            if (Session::has('currency')) 
            {
              $curr = Currency::where('storename',$storename)->find(Session::get('currency'));
            }
    ...
    public function couponcheck($storename)
    {
        $gs = Generalsetting::where('storename',$storename)->first();
        $code = $_GET['code'];
        $total = $_GET['total'];
        $fnd = Coupon::where('storename',$storename)->where('code','=',$code)->get()->count();
        if($fnd < 1)
        {
        return response()->json(0);              
        }
