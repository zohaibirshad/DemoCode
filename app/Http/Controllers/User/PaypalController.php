...
class PaypalController extends Controller
{
 ...
 public function store(Request $request,$storename){
    ...
    $user = Auth::user();
     ...
     $notify_url = action('User\PaypalController@notify',$storename);
...
// Set TCP timeout to 30 seconds
    ...
    if (strcmp($res, "VERIFIED") == 0 || strcasecmp($res, "VERIFIED") == 0) {
        ...
        $order = UserSubscription::where('storename',$storename)->where('user_id','=',$_POST['custom'])
            ->orderBy('created_at','desc')->first();


        $user = User::where('storename',$storename)->findOrFail($_POST['custom']);
        ...
        $payment = UserSubscription::where('storename',$storename)->where('user_id','=',$_POST['custom'])
            ->orderBy('created_at','desc')->first();
        $payment->delete();
