...
class LoginController extends Controller
{
    ...
    {
      $this->code_image();
      return view('user.login',compact('storename'));
    }
    ...
    public function login(Request $request,$storename)
    {
      ...
      if (Auth::attempt(['email' => $request->email, 'password' => $request->password , 'storename' => $storename])) {
        ...
        // Check If Email is verified or not
          ...
          if(!empty($request->modal))
          {
            ...
            if(!empty($request->vendor))
            {
              ...
              {
                return response()->json(route('vendor-dashboard',$storename));
              }
              else {
                return response()->json(route('user-package',$storename));
                }
            }
          ...
          // Login as User
          return response()->json(route('user-dashboard',$storename));
      }
