...
class SocialRegisterController extends Controller
{
    ...
    public function redirectToProvider($storename,$provider)
    {
        return Socialite::driver($provider)->redirect();
    }

    public function handleProviderCallback($storename,$provider)
    {
        try
        {
        ...
        return redirect()->route('user-dashboard',$storename);
